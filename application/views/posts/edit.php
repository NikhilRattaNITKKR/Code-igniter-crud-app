...
<div class="form-group mt-2">
  ...
  <input type="email" class="form-control" name="email" placeholder="Enter Email" value="<?= $post['email'] ?>">
</div>
<div class="form-group mt-2">
  <label for="phone">
    <h5>Phone</h5>
  ...
  <input type="tel" class="form-control" name="phone" placeholder="Enter Phone" value="<?= $post['phone'] ?>">
</div>
<div class="form-group mt-2">
  <label for="">
    <h5>Body </h5>
